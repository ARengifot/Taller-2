...
public class SandboxConjuntos {
    ...
    /**
     * Retorna una colección con las cadenas que hacen parte del conjunto de cadenas y son mayores o iguales a la
     * cadena que se recibe por parámetro
     * 
     * @param cadena
     * @return Una colección de cadenas mayores a la cadena dada. Si la cadena hace parte del conjunto, debe hacer
     *         parte de la colección retornada.
     */
    ...
    /**
     * Reinicia el conjunto de cadenas con las representaciones como Strings de los objetos contenidos en la lista del
     * parámetro 'objetos'.
     * 
    ...
    {
        NavigableSet<String> nuevoConjunto = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);
        nuevoConjunto.addAll(arbolCadenas);
