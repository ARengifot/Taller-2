...
public class SandboxListas {
    ...
    /**
     * Retorna una copia de la lista de enteros, es decir una nueva lista del mismo tamaño que contiene copias de los
     * valores de la lista original
     * 
    ...
    /**
     * Retorna una copia de la lista de cadenas, es decir una nueva lista del mismo tamaño que contiene copias de los
     * valores de la lista original
     * 
    ...
    /**
     * Retorna un arreglo con los valores de la lista de enteros, es decir un arreglo del mismo tamaño que contiene
     * copias de los valores de la lista
     * 
    ...
    /**
     * Agrega un nuevo valor al final de la lista de enteros. Es decir que este método siempre debería aumentar en 1 el
     * tamaño de la lista.
     * 
    ...
    /**
     * Agrega un nuevo valor al final de la lista de cadenas. Es decir que este método siempre debería aumentar en 1 la
     ...
     * @param posicion La posición donde debe quedar el nuevo valor en la lista aumentada. Si la posición es menor a 0,
     *                 se inserta el valor en la primera posición. Si la posición es mayor que el tamaño de la lista, se
     *                 inserta el valor en la última posición.
     */
     ...
     *                 corresponde a ninguna posición de la lista de enteros, el método no debe hacer nada.
     */
    ...
    /**
     * Reinicia la lista de cadenas con las representaciones como Strings de los objetos contenidos en la lista del
     * parámetro 'objetos'.
     * 
     ...
     * 
     * Es decir que si en una posición había un valor negativo, después de ejecutar el método debe quedar el mismo
     * valor muliplicado por -1.
     */
    ...
    /**
     * Compara la lista de enteros con un arreglo de enteros y verifica si contienen los mismos elementos exactamente en
     * el mismo orden.
     * 
